...
## 26. Growth follow-ups — admin accuracy, onboarding, acquisition ⚠️ (built; migrations 0045–0047 pending, auth fixes await review)
...
### 26.10 Status — built, migrations 0045–0047 not yet applied ⚠️

Everything buildable in §26 is built and verified in demo mode; the three migrations need `npx supabase db push` before the live admin screens show the new values (the client degrades cleanly until then).
...
- ✅ **§26.3.2 audit (report):**
  ...
  Fixes wait for Evin's review, per the spec.
