...
- **Shared campaigns are untested with real players.** The schema, RLS, and UI are all in place, but nothing has been exercised end-to-end by two accounts against each other. The claims most worth confirming before relying on it: that a campaign-mate can open your roster but *not* your BTB objective, and that a removed player's warband actually drops out of the standings.
