...
export const strings = {
  ...
  settings: {
    ...
    gameData: {
      section: 'Game data',
      hint: 'The rulebook data this app is built from — each file’s version and where it came from. Tap one to read its source.',
      fileLabel: (name: string, version: number) => `${name} · v${version}`,
      reportHeading: 'Spotted a data error?',
      reportPlaceholder: 'e.g. the Necromancer’s spell list is missing an entry…',
      reportButton: 'Report a data error',
    },
  ...
  auth: {
    ...
    selfReportCardIntro: 'Welcome! One quick, optional question — it helps us know where to find more players.',
    selfReportSave: 'Save',
    selfReportDismiss: 'No thanks',
